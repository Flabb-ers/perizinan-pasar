...
class Pengajuan extends CI_Controller {
	...
	{	
		$datapengajuan= $this->M_pengajuan->tampilAdminPengajuan()->result();
		...
		$this->template->load('pages/index','Admin/v_pengajuan/read', $data); 
	}
	...
	public function create()
	{
		...
		$datapengajuan= $this->M_pengajuan->tampilAdminPerpanjang()->result(); 
		...
		'datawp'=>$this->M_pengajuan->tampilWp()->result(),
 		...
 		$this->template->load('pages/index','Admin/v_pengajuan/create', $data); 
	}
 ...
 //    }
	...
	{	
		...
		'datapengajuan'=>$this->M_pengajuan->tampilData2($id)->row(),
 		...
 		$this->template->load('pages/index','Admin/v_pengajuan/proses', $data); 
	}
	...
	{	
		...
		'datapengajuan'=>$this->M_pengajuan->tampilData2($id)->row()
 		...
 		$this->template->load('pages/index','Admin/v_pengajuan/edit', $data); 
 	}
		...
		if (!empty($_FILES['sp_kepala']['tmp_name']) && !empty($_FILES['sp_pemilik']['tmp_name']) && !empty($_FILES['surat_pernyataan']['tmp_name']) && !empty($_FILES['ktp_pemilik']['tmp_name']) && !empty($_FILES['pas_foto']['tmp_name']) ) {
			if ($_FILES['sp_kepala']['type'] != "image/jpeg" && $_FILES['sp_kepala']['type'] != "image/jpg" && $_FILES['sp_kepala']['type'] != "image/png" && $_FILES['sp_pemilik']['type'] != "image/jpeg" && $_FILES['sp_pemilik']['type'] != "image/jpg" && $_FILES['sp_pemilik']['type'] != "image/png" && $_FILES['surat_pernyataan']['type'] != "image/jpeg" && $_FILES['surat_pernyataan']['type'] != "image/jpg" && $_FILES['surat_pernyataan']['type'] != "image/png" && $_FILES['ktp_pemilik']['type'] != "image/jpeg" && $_FILES['ktp_pemilik']['type'] != "image/jpg" && $_FILES['ktp_pemilik']['type'] != "image/png" && $_FILES['pas_foto']['type'] != "image/jpeg" && $_FILES['pas_foto']['type'] != "image/jpg" && $_FILES['pas_foto']['type'] != "image/png" ) {
                ...
                $pas_foto =
	 			...
	 			unlink(FCPATH.('template/img/syarat2/'.$this->input->post('sp_kepala_lama2')));
	 			unlink(FCPATH.('template/img/syarat2/'.$this->input->post('sp_pemilik_lama2')));
	 			unlink(FCPATH.('template/img/syarat2/'.$this->input->post('surat_pernyataan_lama2')));
	 			unlink(FCPATH.('template/img/syarat2/'.$this->input->post('ktp_pemilik_lama2')));
	 			unlink(FCPATH.('template/img/syarat2/'.$this->input->post('pas_foto_lama2')));
    	...
    	public function print()
	{
		...
		$data = [ 
			...
			'datapengajuan'=>$this->M_pengajuan->tampilJoin()->result()
	 		...
	 		$this->load->view('Admin/v_pengajuan/print', $data); 
	}
	...
	public function cetak_pdf()
	{
		...
		$this->load->view('Admin/v_pengajuan/cetak_pdf', $data);
