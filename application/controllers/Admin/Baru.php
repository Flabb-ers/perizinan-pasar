...
class Baru extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->template->load('pages/index', 'Admin/v_baru/read', $data);
	}
	...
	public function edit($id)
	{
		...
		$this->template->load('pages/index', 'Admin/v_baru/edit', $data);
	}
	...
	public function update($id)
{
	...
	public function proses($id)
	{
		...
		$this->template->load('pages/index', 'Admin/v_baru/proses', $data);
	}
	...
	public function print()
	{
		...
		$this->load->view('Admin/v_baru/print', $data);
	}
	...
	public function cetak_pdf()
	{
		...
		$this->load->view('Admin/v_baru/cetak_pdf', $data);
