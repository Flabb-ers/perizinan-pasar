...
class Laporan extends CI_Controller {
    ...
    public function laporansemua(){
            $pengajuan = $this->M_baru->tampilJoin()->result();
            $pasar = $this->M_baru->tampilPasar()->result();
        ...
        $this->template->load('pages/index','Admin/v_laporan/read', $data); 
    }
...
public function filterPengajuan()
    {
        ...
        if ($id_pasar !== 'Pilih Pasar') {
            $data['pengajuan'] = $this->M_baru->filterByDateDinas($tgl_awal, $tgl_akhir, $id_pasar);
        }else{
            $data['pengajuan'] = $this->M_baru->filterByDate($tgl_awal, $tgl_akhir);
        }
    ...
    public function exportLaporanPasar()        
    {
        ...
        if ($id_pasar !== 'Pilih Pasar') {
            $dataPengajuan = $this->M_baru->filterByDateDinas($tgl_awal, $tgl_akhir, $id_pasar);
        }else{
            $dataPengajuan = $this->M_baru->filterByDate($tgl_awal, $tgl_akhir);
            $nama = '';
        }
        ...
        header("Content-Disposition: attachment; filename=PermohonanBaru $tgl_awal-$tgl_akhir.xls");
