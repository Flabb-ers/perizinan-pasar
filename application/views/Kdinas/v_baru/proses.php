						...
						<div class="box-body">
							...
							<div class="modal-body">
								...
								<div class="form-group row">
									...
									<div class="col-md-9 col-sm-9">
										<input type="date" name="tgl_daftar" id="tgl_daftar" value="<?php echo $dataop->tgl_daftar ?>" class="form-control" readonly>
									</div>
								</div>
								<div class="form-group row">
									<label class="col-md-3 col-sm-3">Batas Berlaku</label>
									<div class="col-md-9 col-sm-9">
										<input type="date" name="batas_berlaku" id="batas_berlaku" value="<?php echo $dataop->batas_berlaku ?>" class="form-control" readonly>
