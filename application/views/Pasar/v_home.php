                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <p class="card-text"><?= $this->session->userdata('level') ?></p>
                        </div>
                    </div>
                </div>
            </div></br></br></br>
                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">
                                        <h3 class="h5 mb-0 font-weight-bold text-gray-800"><?= $this->db->query("SELECT * FROM tbl_kios")->num_rows() ?></h3>
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    JOIN tbl_pasar ON tbl_kios.id_pasar=tbl_pasar.id_pasar 
                                    JOIN tbl_tarif ON tbl_kios.id_tarif=tbl_tarif.id_tarif 
                                    where tbl_tarif.jenis = 'Kios'")->num_rows()
                                            ?>
                                            <?= $jml_terpakai ?>
                                        </h6>
                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    JOIN tbl_pasar ON tbl_kios.id_pasar=tbl_pasar.id_pasar 
                                    JOIN tbl_tarif ON tbl_kios.id_tarif=tbl_tarif.id_tarif 
                                    where tbl_tarif.jenis = 'Los'")->num_rows()
                                            ?>
                                            <?= $jml_terpakai ?>
                                        </h6>
                                        <h6 class="font-weight-bold text-gray-800">Jumlah Kios Kosong =
