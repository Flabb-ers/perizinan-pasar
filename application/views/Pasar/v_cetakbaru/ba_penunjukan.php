...
<body>
	<table>
		<tbody>
			...
			<tr>
				<td class="ijin-menempati">IJIN MENEMPATI <?=strtoupper($dataop->nama_pasar)?> </td>
			</tr>
			<tr>
			...
			<tr>
				<td class="indent">Nama 	<span style="margin-left:30px">:</span></td>
			</tr>
			<tr>
				<td class="indent">NIP 		<span style="margin-left:43px">:</span></td>
			</tr>
			<tr>
				<td class="indent">Jabatan 	<span style="margin-left:20px">:</span></td>
			</tr>
			<tr>
				<td><br></td>
			</tr>
			<tr>
				<td>Menunjuk untuk menempati Los/Kios/Selsasar Blok: <?=$dataop->nama_blok?> Nomor :  <?=$dataop->no_blok?>  </td>
			</tr>
			<tr>
			...
			<tr>
				<td class="indent">Nama 	<span style="margin-left:30px">:</span>  <?=$dataop->nama?></td>
			</tr>
			<tr>
				<td class="indent">Alamat 	<span style="margin-left:22px">:</span>  <?=$dataop->alamat?></td>
			</tr>
			<tr>
			...
			<tr>
				<td>
					<table width="100%">
						...
						<tr>
							<td style="text-align: center;">Kepala <?=$datakepala->nama_pasar?></td>
							<td></td>
						</tr>
						<tr>
							<td height="110"></td>
						...
						<tr>
							...
							<td style="text-align: center;"><u>( <?=$dataop->nama?> )</u></td>
						</tr>
						<tr>
