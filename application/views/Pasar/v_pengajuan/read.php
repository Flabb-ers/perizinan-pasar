						...
						<tbody>
							...
							?>
								<tr>
									...
									<td>
										<a href="<?php echo site_url('Pasar/Pengajuan/edit/' . $key->id_pengajuan) ?>" class="btn btn-success">Upload</a>
										<a href="<?php echo site_url('Pasar/Pengajuan/hapus/' . $key->id_pengajuan) ?>" onclick="javascript: return confirm('Yakin Mau dihapus <?= $key->jenis ?> <?= $key->nama_blok ?> <?= $key->no_blok ?>')" class="btn btn-danger"><i class="fa fa-trash"></i></a>
									</td>
								</tr>
							<?php
								$no++;
