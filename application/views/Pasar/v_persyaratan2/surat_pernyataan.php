	...
	<table>
		<thead>
			...
			<tr>
				...
				<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;</td>
				<td> <?php echo $datapengajuan->jenis_dagangan ?> </td>
			</tr>
			<tr>
				<td>NIK</td>
				<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;</td>
			...
			<tr>
				<td>No NPWRD</td>
				<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;</td>
				<td> <?php echo $datapengajuan->npwrd ?> </td>
			</tr><br>
		</thead>
	</table><br>
	<table width="100%" align="justify">
		<thead>
			<tr width="100%" align="justify">Menyatakan bahwa saya benar - benar menggunkaan tempat <?php echo $datapengajuan->jenis ?> yang ada di <?php echo $datapengajuan->nama_pasar ?> Blok <?php echo $datapengajuan->nama_blok ?> Nomor <?php echo $datapengajuan->no_blok ?> Ukuran <?php echo $datapengajuan->panjang ?> M x <?php echo $datapengajuan->lebar ?> M untuk berdagang <?php echo $datapengajuan->jenis_dagangan ?>.<br><br>
		...
		<thead>
			<tr>
				...
				<td width="50%" align="center">
					...
					<p><?php echo $datapengajuan->nama ?></p>
				</td>
			</tr>
		</thead>
	</table>
