							...
							?>
								<tr>
									...
									<td>
										...
										<a href="<?php echo site_url('Admin/Baru/edit/' . $key->id_pengajuan) ?>" class="btn btn-success">Upload</i></a>
										<a href="<?php echo site_url('Admin/Baru/proses/' . $key->id_pengajuan) ?>" class="btn btn-primary"><i class="fa fa-edit">Proses</i></a>
										<a href="<?php echo site_url('Admin/Baru/hapus/' . $key->id_pengajuan) ?>" onclick="javascript: return confirm('Yakin Mau dihapus <?php echo $key->nama ?>')" class="btn btn-danger"><i class="fa fa-trash"></i></a>
