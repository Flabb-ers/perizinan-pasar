			...
			<div class="row">
				<div class="col-12">
					<div class="box box-warning">
						<div class="box-body">
							<form class="" action="<?php echo site_url('Admin/Selasar/create') ?>" method="post">
								...
								<div class="modal-body">
									<div class="form-group row">
										<div class="col-md-6 mb-6 mb-sm-0">
											...
											<select class="form-control select2bs4" name="id_pasar" style="width: 100%;">
									...
									<a href="<?php echo site_url('Admin/Selasar') ?>"><button name="simpan" type="submit" class="btn btn-primary">Submit</button></a>
