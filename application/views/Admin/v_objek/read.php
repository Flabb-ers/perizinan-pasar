					...
					<tbody>
						...
						?>
							<tr>
								...
								<td>
									<a href="<?php echo site_url('Admin/Objek/detail/' . $key->id_objek) ?>" class="btn btn-success"><i class="fa fa-edit"> Detail</i></a>

									<a href="<?php echo site_url('Admin/Objek/hapus/' . $key->id_objek) ?>" onclick="javascript: return confirm('Yakin Mau dihapus <?php echo $key->nama ?>')" class="btn btn-danger"><i class="fa fa-trash"> Hapus</i></a>
								</td>
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<div class="dropdown-menu animated--fade-in" aria-labelledby="dropdownMenuButton">
						<a class="dropdown-item" href="<?php echo site_url('Admin/Op/download_OP'); ?>" target="_blank">Kode Objek Retribusi</a>
						<a class="dropdown-item" href="<?php echo site_url('Admin/Op/download_Kios'); ?>" target="_blank">Kode Kios</a>
						<a class="dropdown-item" href="<?php echo site_url('Admin/Op/download_Jenis'); ?>" target="_blank">Kode Jenis</a>
						<a class="dropdown-item" href="<?php echo site_url('Admin/Op/download_template'); ?>" target="_blank">Template</a>
					</div>
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button class="btn btn-info btn-sm dropdown-toggle" type="button"
						...
						aria-expanded="false"><i class="fa fa-download"></i>Download</button>
					<div class="dropdown-menu animated--fade-in" aria-labelledby="dropdownMenuButton">
						<a class="dropdown-item" href="<?php echo site_url('Admin/Op/download_WP'); ?>" target="_blank">Kode Wajib Retribusi</a>
						<a class="dropdown-item" href="<?php echo site_url('Admin/Op/download_templateWP'); ?>" target="_blank">Template</a>
					</div>
					<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
					<button type="submit" name="submit" class="btn btn-primary">Import</button>
