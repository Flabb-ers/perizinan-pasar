...
<div class="col-6">
    <div class="box box-warning">
        <div class="box-body">
		<form class="" action="<?php echo site_url ('Admin/Tarif/create') ?>" method="post">
        ...
        <div class="form-group">
        <label>Letak Kios/Los</label><br>
        <input type="text" name="letak_kioslos" pattern="[A-Za-z -]+"  class="form-control" required>
        </div>
        <div class="form-group">
        <label>Tarif</label><br>
        <input type="text" name="tarif" pattern="^[0-9]{3,4}$" class="form-control" required>
        </div>
        
        <a href="<?php echo site_url('Admin/Tarif') ?>"><button name="simpan" type="submit" class="btn btn-primary">Submit</button></a>
