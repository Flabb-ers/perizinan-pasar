					...
					<div class="modal-body">
						...
						<div class="form-group row">
							<div class="col-md-6 mb-6 mb-sm-0">
								...
								<select class="form-control" name="id_objek_pajak" id="pengajuan" style="width: 100%;" required>
									...
									?>
										<option value="<?= $key->id_objek_pajak ?>" required><?php echo $key->nama_pasar ?> <?php echo $key->jenis ?> <?php echo $key->nama_blok ?> <?php echo $key->no_blok ?> </option>
									<?php } ?>
								</select>
							</div>
						...
						<div class="form-group">
							<div class="col-md-12 col-sm-7  offset-md-10">
								<a href="<?php echo site_url('Admin/Persyaratan2') ?>"><button name="simpan" type="submit" class="btn btn-primary">Submit</button></a>
										...
										?>
											<tr>
												...
												<td>
													...
													<br>
													<!-- <a href="<?php echo site_url('Admin/Persyaratan2/edit/' . $key->id_pengajuan) ?>" class="btn btn-success btn-sm"><i class="fa fa-edit"></i>Edit</a><br> -->
													<a href="<?php echo site_url('Admin/Persyaratan2/hapus/' . $key->id_pengajuan) ?>" onclick="javascript: return confirm('Yakin Mau dihapus <?php echo $key->jenis ?> <?php echo $key->nama_blok ?> <?php echo $key->no_blok ?> ')" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i>Hapus</a><br>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$('#pengajuan').on('change', function() {
				...
				$.ajax({
					url: '<?php echo base_url('Admin/Persyaratan2/getPengajuan'); ?>',
					type: 'POST',
					data: {
