...
<div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary">Edit Form Permohonan Baru</h6>
</div>
<div class="card-body">  
<div class="row">
<div class="col-12">
    ...
    <div class="box-body"> 
        <?php echo form_open_multipart ('Admin/Persyaratan2/update/'.$datapengajuan->id_pengajuan) ?>
        ...
        <div class="col-md-6">
            ...
            <div class="col-md-6 mb-6 mb-sm-0">
                ...
                <input type="text" name="pekerjaan"  id="pekerjaan" value="<?php echo $datapengajuan->pekerjaan ?>"class="form-control" readonly >
            </div>
            <div class="col-md-6">
                <label>Alamat</label>
        ...
        <div class="form-group row">
            <div class="col-md-6 mb-6 mb-sm-0">
                ...
                <input type="text" name="id_jenis" id="id_jenis" value="<?php echo $datapengajuan->jenis_dagangan ?>" class="form-control" readonly >
            </div>
            <div class="col-md-6">
        ...
        <a href="<?php echo site_url('Admin/Persyaratan2') ?>"><button type="button" name="button" class="btn btn-warning">Cancel</button>  
         <?php echo form_close(); ?>
        </div>
    </div>
    </div>
