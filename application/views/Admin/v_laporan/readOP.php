...
<div class="container-fluid">
	<div class="card shadow mb-12">
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-primary">Laporan Objek Retribusi</h6>
		</div>
		...
		<div class="card-body">
			...
			<div class="form-group">
				<div class="col-md-6 col-sm-6  offset-md-6">
					...
					<a href="<?php echo site_url('Admin/LaporanOP/laporansemua') ?>" class="btn btn-secondary ">Reset</a>
				</div>
			</div>
...
<script>
	$(document).ready(function() {
		$("#cari").click(function() {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url('Admin/LaporanOP/filterPengajuan'); ?>",
				data: {
					tgl_awal: tgl_awal,
					tgl_akhir: tgl_akhir,
					id_pasar: id_pasar,
		...
		$("#export-btn").click(function() {
			...
			window.location.href = "<?php echo base_url('Admin/LaporanOP/exportLaporanPasar'); ?>" + "?tgl_awal=" + tgl_awal + "&tgl_akhir=" + tgl_akhir + "&id_pasar=" + id_pasar;
		});
	});
</script>
