...
<div class="container-fluid">
	<div class="card shadow mb-12">
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-primary">Laporan Objek Retribusi Non AKtif</h6>
		</div>
		...
		<div class="card-body">
			...
			<div class="form-group">
				<div class="col-md-6 col-sm-6  offset-md-6">
					...
					<a href="<?php echo site_url('Admin/LaporanOPnonaktif/laporansemua') ?>" class="btn btn-secondary ">Reset</a>
				</div>
			</div>
...
<script>
	$(document).ready(function() {
		$("#cari").click(function() {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url('Admin/LaporanOPnonaktif/filterPengajuan'); ?>",
				data: {
					id_pasar: id_pasar,
		...
		$("#export-btn").click(function() {
			...
			window.location.href = "<?php echo base_url('Admin/LaporanOPnonaktif/exportLaporanPasar'); ?>" + "&id_pasar=" + id_pasar;
		});
	});
</script>
