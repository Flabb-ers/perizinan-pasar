...
<html lang="en"><style type="text/css">
    body{
        font-family: times-new-roman; font-size: 9pt; background-color: #fff
            margin-right: 40px; margin-top: 37px; margin-left: 70px;
            }
        .rangkasurat {auto;background-color: #fff;  padding: 0px; 
            }
        table{ padding: 0px}
        .hr {border-bottom: 5px solid #000;}
        .tengah {text-align: center;line-height: 1px;}
        .tidaktengah {text-align: justify;  margin-right: 70px; margin-left: 0px;}
        p{line-height: 1px;}
    ...
    <div class="rangkasurat"><table class="hr" width="100%">
        <thead><tr>
            <td></td>
       ...
       <h4 class="justify">Berdasarkan Peraturan Daerah Kabupaten Purworejo Nomor 17 Tahun 2007,  Atas nama Bupati Purworejo <br>dalam hal ini bertindak untuk dan atas nama Pemerintah Daerah Kabupaten Purworejo dengan ini <br>memberikan izin kepada : </h4>
        ...
        </table><p>&nbsp;</p><p margin-right="70px" margin-left= "0px">
            ...
            m yang terletak di Kompleks 
                ...
                <?php } }?></p><p>
                untuk berjualan <?php echo $dataop->jenis_dagangan?> dengan ketentuan : </p><table class="tidaktengah">
                    <thead><tr>
                <td>1.</td>
                ...
                <td valign="top">9.</td>
                <td>Izin Menempati <?php echo $datakios->jenis?> dapat dicabut apabila :<tr><td></td>
