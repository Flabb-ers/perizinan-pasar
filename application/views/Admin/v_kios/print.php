...
<body>
    ...
    <table class="hr">
        ...
        <div class="tengah">
            <h5><b><u>Laporan Data Objek Pajak</u></b></h5>
        </div></br>
            <table class="table table-bordered" border-color="#000" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <?php
                         ...
                         <td><?= $key->nama_blokpasar ?></td>
                         <td><?= $key->no_kioslos ?></td>
                         <td><?= $key->luas=$key->panjang*$key->lebar?></td>
                         <td><?= $key->tarif ?></td>
                         <td><?= $key->total=$key->luas*$key->tarif?></td>
