						...
						<tbody>
							...
							?>
								<tr>
									...
									<td>
										<a href="<?php echo site_url('Admin/Pengajuan/edit/' . $key->id_pengajuan) ?>" class="btn btn-success">Upload</a>
										<a href="<?php echo site_url('Admin/Pengajuan/proses/' . $key->id_pengajuan) ?>" class="btn btn-primary"><i class="fa fa-edit">Proses</i></a>
										<a href="<?php echo site_url('Admin/Pengajuan/hapus/' . $key->id_pengajuan) ?>" onclick="javascript: return confirm('Yakin Mau dihapus <?php echo $key->nama ?>')" class="btn btn-danger"><i class="fa fa-trash"></i></a>
									</td>
								</tr>
							<?php
								$no++;
