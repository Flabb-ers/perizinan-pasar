...
<div class="container-fluid">
	...
	<div class="card shadow mb-4">
		...
		<div class="box-body">
			<form class="" action="<?php echo site_url('Admin/Persyaratan/create') ?>" method="post" enctype="multipart/form-data">
				<div class="modal-body">
				<input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">

					<div class="form-group row">
						<label class="col-md-2 col-sm-0">Nama Pasar & Kios</label>
						<div class="col-md-4 mb-6 col-sm-">
							<select class="form-control" name="id_kios" id="id_kios" style="width: 100%;" required>
								...
								?>
									<option value="<?= $key->id_kios ?>" required><?php echo $key->nama_pasar . '' . $key->jenis . ' ' . $key->nama_blok . ' No ' . $key->no_blok ?></option>
								<?php } ?>
							</select>
						</div>
						<label class="col-md-2 col-sm-2">Nama</label>
					...
					<div class="form-group row">
						...
						<div class="col-md-4 mb-6 col-sm-">
							<input type="text" name="no_telp" pattern="(\+62|62|0)8[1-9][0-9]{6,9}$" class="form-control" required>
						</div>
					...
					<input type="hidden" name="tanggal" value=" <?php echo date('d-m-Y') ?>" class="form-control" readonly>
					...
					<div class="form-group">
						<div class="col-md-12 col-sm-7  offset-md-10">
							<a href="<?php echo site_url('Admin/Persyaratan') ?>"><button name="simpan" type="submit" class="btn btn-primary">Submit</button></a>
									...
									?>
										<tr>
											...
											<td>
												...
												<br>
												<a href="<?php echo site_url('Admin/Persyaratan/edit/' . $key->id_pengajuan) ?>" class="btn btn-success btn-sm"><i class="fa fa-edit"></i>Edit</a><br>
												<a href="<?php echo site_url('Admin/Persyaratan/hapus/' . $key->id_pengajuan) ?>" onclick="javascript: return confirm('Yakin Mau dihapus <?php echo $key->nama ?>')" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i>Hapus</a><br>
