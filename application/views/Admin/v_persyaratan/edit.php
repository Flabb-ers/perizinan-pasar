<div class="container-fluid">
	...
	<div class="card shadow mb-6">
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-primary">Edit Form Pengajuan Baru</h6>
		</div>
		<div class="card-body">
			<div class="row">
				<div class="col-12">
					<div class="box box-warning">
						<div class="box-body">
							<?php echo form_open_multipart('Admin/Persyaratan/update/' . $databaru->id_pengajuan) ?>
									...
									<select class="form-control" name="id_kios" id="id_kios" style="width: 100%;" required>
										...
										?>
											...
											<option value="<?= $key->id_kios ?>" <?php if ($key->id_kios == $databaru->id_kios) {
																						echo "selected";
																					} ?>><?php echo $key->nama_pasar . ' -- ' . $key->jenis . ' ' . $key->nama_blok . ' No ' . $key->no_blok ?></option>
							...
							<div class="form-group row">
								...
								<div class="col-md-6">
									<label>Alamat</label>
									<input type="text" name="alamat" value="<?php echo $databaru->alamat ?>" pattern="[0-9A-Za-z .,]+" class="form-control" required>
								</div>
							</div>
							<div class="form-group row">
								<div class="col-md-6 mb-6 mb-sm-0">
							...
							<a href="<?php echo site_url('Admin/Persyaratan') ?>"><button type="button" name="button" class="btn btn-warning">Cancel</button>
								<?php echo form_close(); ?>
						</div>
					</div>
				</div>
