...
<div class="container-fluid">
	...
	<div class="card shadow mb-4">
		...
		<div class="card-body">
			<a href="<?php echo site_url('Dinas/Wp/create') ?>"><button type="button" class="btn btn-primary btn-sm mr-2"><i class="fa fa-plus"></i>
					Tambah Data
				</button></a><button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#importExcel" onclick="return confirm('Siapkan data excel dengan header: \nKode Pasar, Nama Pasar, NPWRD, Nama, NIK, Alamat, No. Telepon, Email\nKlik Oke dan Download Kode Pasar untuk menyesuaikan Kode Pasar dan Download Template untuk penyesuaian format yang akan diimport  ')">
				IMPORT EXCEL
			</button><br><br>
...
<div class="modal fade" id="importExcel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	...
	<form method="post" action="<?php echo site_url('Dinas/Wp/importWp'); ?>" enctype="multipart/form-data">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <div class="dropdown-menu animated--fade-in" aria-labelledby="dropdownMenuButton">
                        <a class="dropdown-item" href="<?php echo site_url('Dinas/Wp/download_Kpasar'); ?>" target="_blank">Kode Pasar</a>
                        <a class="dropdown-item" href="<?php echo site_url('Dinas/Wp/download_template'); ?>" target="_blank">Template</a>
                    </div>
