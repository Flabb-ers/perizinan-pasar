			...
			<div class="row">
				<div class="col-12">
					<div class="box box-warning">
						<div class="box-body">
							<form class="" action="<?php echo site_url('Dinas/Objek/create') ?>" method="post">
								...
								<div class="modal-body">
									...
									<a href="<?php echo site_url('Dinas/Objek') ?>"><button name="simpan" type="submit" class="btn btn-primary">Submit</button></a>
									<button type="reset" name="reset" class="btn btn-danger">Reset</button>
									<a href="<?php echo site_url('Dinas/Objek') ?>"><button type="button" name="button" class="btn btn-warning">Cencel</button>
								</div>
							</form>
						</div>
					</div>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#pengajuan').on('change', function() {
			...
			$.ajax({
				url: '<?php echo base_url('Dinas/Objek/getPengajuan'); ?>',
				type: 'POST',
				data: {
