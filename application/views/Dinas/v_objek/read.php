...
<div class="container-fluid">
	...
	<div class="card shadow mb-4">
		...
		<div class="card-body">
			...
			<button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#importExcel" onclick="return confirm('Siapkan data excel dengan header: \nKode Kios, Kode Jenis, Nama Pasar, NPWRD, Nama, Alamat, No. Telepon, Email, Jenis, Nama Blok, No Blok, Tgl Daftar, Batas Berlaku, Status = Sudah\nKlik Oke dan Download Kode Pasar untuk menyesuaikan Kode Pasar dan Download Template untuk penyesuaian format yang akan diimport  ')">
				IMPORT EXCEL
			</button>
			<hr>
			<br>
					...
					<tbody>
						...
						?>
							<tr>
								...
								<td>
									<a href="<?php echo site_url('Dinas/Objek/detail/' . $key->id_objek) ?>" class="btn btn-warning"><i class="fa fa-edit"> Detail</i></a>

									<a href="<?php echo site_url('Dinas/Objek/hapus/' . $key->id_objek) ?>" onclick="javascript: return confirm('Yakin Mau dihapus <?php echo $key->id_objek ?>')" class="btn btn-danger"><i class="fa fa-trash"> Hapus</i></a>
								</td>
...
<div class="modal fade" id="importExcel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<form method="post" action="<?php echo site_url('Dinas/Objek/importWp'); ?>" enctype="multipart/form-data">
