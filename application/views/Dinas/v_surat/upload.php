                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                <div class="col-md-12 text-center">
                                    <a href="<?= base_url('Dinas/Cetak2/print/' . $objek_pajak->id_objek_pajak); ?>" target="_blank" class="btn btn-danger"><i class="fa fa-download">Cetak</i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12 text-center">
                                    ...
                                    if (file_exists($file_path)) : ?>
                                        <a href="<?= base_url('Dinas/Cetak2/downloadSurat/' . $objek_pajak->id_objek_pajak); ?>" class="btn btn-success">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <form action="<?= base_url('Dinas/Cetak2/upload/' . $objek_pajak->id_objek_pajak); ?>" method="POST" enctype="multipart/form-data" id="uploadForm">
                                ...
                                <div class="mt-3">
                                    ...
                                    <a href="<?= base_url('Dinas/Cetak2') ?>" class="btn btn-secondary ml-2">Kembali</a>
                                </div>
                            </form>
                        </div>
                    </div>
