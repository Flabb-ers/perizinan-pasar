<div class="container-fluid">
	...
	<div class="card shadow mb-6">
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-primary">Tambah Detail Objek Retribusi</h6>
		</div>
		<div class="card-body">
			<div class="row">
				<div class="col-12">
					<div class="box box-warning">
						<div class="box-body">
							<form class="" action="<?php echo site_url('Dinas/Op/save') ?>" method="post">
								...
								<div class="modal-body">
									...
									<a href="<?php echo site_url('Dinas/Op') ?>"><button value="Simpan" type="submit" class="btn btn-primary">Submit</button></a>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#pengajuan').on('change', function() {
			...
			$.ajax({
				url: '<?php echo base_url('Dinas/Op/getPengajuan'); ?>',
				type: 'POST',
				data: {
