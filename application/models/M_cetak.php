...
class M_cetak extends CI_Model
{
	...
	public function readAllPasar()
	{
		...
		$this->db->order_by('tbl_op.updated_at', 'DESC');
		$query = $this->db->get();
		return $query;
	}

	public function tampilAllPasar()
	{
	...
	public function tampilKios($id_objek_pajak)
	{
		$this->db->select('tbl_kios.*, tbl_pasar.*, tbl_tarif.*, tbl_op.id_objek_pajak, tbl_pengajuan.id_pengajuan');
		$this->db->from('tbl_kios');
		$this->db->join('tbl_pasar', 'tbl_kios.id_pasar = tbl_pasar.id_pasar');
		$this->db->join('tbl_tarif', 'tbl_kios.id_tarif = tbl_tarif.id_tarif');
		$this->db->join('tbl_pengajuan', 'tbl_kios.id_kios = tbl_pengajuan.id_kios');
		$this->db->join('tbl_op', 'tbl_pengajuan.id_pengajuan = tbl_op.id_pengajuan');
